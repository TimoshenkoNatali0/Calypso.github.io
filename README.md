  ...
  <section class="hero">
    <div class="container hero-grid">
      <div>
        ...
        <p>Создаем образ, который запомнят даже без фотошопа.
            <!-- !(Сцена, театр,) кино, шоу, музей, фотосессия, съемка клипов, костюмированная вечеринка, файер шоу. Ручная работа, которая превращает замысел в артефакт.
              -->
            </p>
       
            <a href="#" class="btn-primary">Смотреть портфолио</a>
        <div class="hero-stats">
          <div><span>6+</span><small>лет опыта</small></div>
          <div><span>> 50</span><small>созданных образов</small></div>
          <div><span>100%</span><small>ручная выделка</small></div>
        </div>
      </div>
      <div class="hero-image-placeholder">
          <img src="img/main.jpg" width="700px">
      </div>
    </div>
  </section>
  ...
  <div class="container">
    ...
    <div class="advantages-grid">
      ...
      <div class="advantage-item">
        ...
        <h4>Ручная работа</h4>
        <p>Каждый шов, каждая пряжка и каждое тиснение выполнены <span class="highlight">вручную</span>.</p>
      </div>
      <!-- 2 -->
      <div class="advantage-item">
        <span class="adv-icon">🐂</span>
        <h4>Только натуральная кожа</h4>
        <p>Работаем с <span class="highlight">вегетарианской</span> и <span class="highlight">хромовой</span> выдубкой. Кожа дышит, стареет красиво и служит десятилетиями.</p>
      </div>
      <!-- 3 -->
      <div class="advantage-item">
    ...
    <div class="expert-wrap">
      ...
      <div class="expert-photo">
        <div class="photo-placeholder">
          ...
          <small>(загрузите портрет)</small>
        </div>
        <div class="expert-sign">
          <span class="sign-name">Имя Мастера</span>
      ...
      <div class="expert-content">
        ...
        <div class="expert-text">
          <p class="lead">
            <span class="gold-text">●</span> Здесь будет текст о мастере. 
            Расскажите о своём пути: сколько лет в профессии, 
            с чего начинали, в чём ваша уникальная философия.
          </p>
          <p>
            <strong>Ключевые точки для заполнения:</strong><br>
            — Опыт работы с кожей (цифры подкрепляют доверие)<br>
            — Специализация: исторические реконструкции / фэнтези-доспехи / театральные костюмы<br>
            — Образование или обучение у известных мастеров<br>
            — Личный подход к каждому заказу
          </p>
          <p>
            <strong>Пример заполнения:</strong><br>
            «Более 12 лет я создаю кожаные доспехи и костюмы для сцены. 
            Начинал с исторической реконструкции викингов, затем ушёл в фэнтези 
            и театральные проекты. Моя философия — каждая вещь должна 
            <span class="gold-text">жить</span> на человеке, а не просто висеть на плечиках. 
            Поэтому я снимаю более 20 мерок и делаю индивидуальные лекала 
            под каждую фигуру.»
          </p>
        </div>
...
<section class="reviews">
  ...
  <!-- СЕКЦИЯ: ПРИЗЫВ К ДЕЙСТВИЮ + ФОРМА -->
<section class="cta">
  <div class="container">
    <div class="cta-wrap">
